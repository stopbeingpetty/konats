...
export function ReservationsImport({ roomTypes }: Props) {
    ...
    return (
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-auto p-8 space-y-8">
          <UploadZone onFileSelect={(f) => void processFile(f)} parseError={parseError} />
    ...
    return (
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-auto p-8 space-y-5">
          <ImportSummary stats={summaryStats} fileName={file?.name} fileSize={file?.size} />
            ...
            <div className="flex items-center gap-4">
              {actionableCount > 0 && (
                <p className="font-sans text-xs text-[rgba(26,26,26,0.45)]">
                  ...
                  <span className="font-medium text-[#1A1A1A]">{summaryStats.newCount} new</span>
